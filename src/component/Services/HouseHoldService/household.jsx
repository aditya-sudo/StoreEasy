...
import householdStorage from "../../../images/household_image.jpeg";
    ...
    <div className="main-container">
      ...
      <div className="content-container">
        ...
        <div className="main-content">
          <h2 className="main-content-title">Household Storage</h2>
          ...
          <br />
            ...
            to wine and holiday décor. Storekaro.com can keep your things safe
